...
namespace document.lib.api.Migrations
{
    ...
    [Migration("20200401091536_add-register-display-name")]
    partial class addregisterdisplayname
    {
            ...
            modelBuilder.Entity("document.lib.api.Models.LibDocument", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("Date")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 4, 1, 11, 15, 36, 460, DateTimeKind.Unspecified).AddTicks(3149), new TimeSpan(0, 2, 0, 0, 0)));
