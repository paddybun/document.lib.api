...
namespace document.lib.api.Migrations
{
    ...
    [Migration("20190601062633_add-document-date")]
    partial class adddocumentdate
    {
            ...
            modelBuilder.Entity("document.lib.api.Models.LibDocument", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("Date")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2019, 6, 1, 8, 26, 32, 980, DateTimeKind.Unspecified).AddTicks(1954), new TimeSpan(0, 2, 0, 0, 0)));
