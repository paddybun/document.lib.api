...
public class PropertyCheckerTests
{
    ...
    public void Any_OneValue_ReturnsTrue()
    {
        ...
        var actual = PropertyValidator.AnyHasValue(mockObject, x => x.toTest);
        var expected = true;
    ...
    public void Any_MultipleNullable_ReturnsFalse()
    {
        ...
        var actual = PropertyValidator.AnyHasValue(mockObject, x => x.toTest, x => x.toTest2);
        var expected = false;
        Assert.Equal(expected, actual);
    }
    ...
    public void All_OneValue_ReturnsTrue()
    {
        ...
        var actual = PropertyValidator.AllHaveValue(mockObject, x => x.toTest);
        var expected = true;
        Assert.Equal(expected, actual);
    }
    ...
    public void All_MultipleNullable_ReturnsFalse()
    {
        ...
        var actual = PropertyValidator.AllHaveValue(mockObject, x => x.toTest, x => x.toTest2);
        var expected = false;
        Assert.Equal(expected, actual);
    }
    ...
    public void All_EmptyStringAndValueAndNullable_ReturnsFalse()
    {
        ...
        var actual = PropertyValidator.AllHaveValue(mockObject, x => x.toTest, x => x.toTest2, x => x.toTest3);
        var expected = false;
        Assert.Equal(expected, actual);
    }
}