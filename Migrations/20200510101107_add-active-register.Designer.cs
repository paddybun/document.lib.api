...
namespace document.lib.api.Migrations
{
    ...
    [Migration("20200510101107_add-active-register")]
    partial class addactiveregister
    {
            ...
            modelBuilder.Entity("document.lib.api.Models.LibDocument", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("Date")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 5, 10, 12, 11, 7, 869, DateTimeKind.Unspecified).AddTicks(5165), new TimeSpan(0, 2, 0, 0, 0)));
